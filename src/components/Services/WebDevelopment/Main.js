...
const CyberSecurity = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "you can visit our website and look for Contact Us section. You can call us any time on our service numbers. And also you can mail us on our given email addresses.",
    },
  ];
  ...
  return (
    <>
      ...
      >
        <Breadcumb Title="Web Development" Breadcumb="SERVICES" />
